...
-- 시퀀스 생성
CREATE SEQUENCE SEQ_MATERIALS INCREMENT 		BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_FAQ INCREMENT 				BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_MAGAZINE INCREMENT 			BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_NOTICE_FILE INCREMENT 		BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_NOTICE INCREMENT 			BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_ITEM_REIVEW_FILE INCREMENT 	BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_ITEM_REIVEW INCREMENT 		BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_CATALOG_FILE INCREMENT 		BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_CATALOG INCREMENT 			BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_QNA_FILE INCREMENT 			BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_QNA INCREMENT 				BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_CART INCREMENT 				BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_ITEM INCREMENT 				BY 1 START WITH 0 MINVALUE 1;
CREATE SEQUENCE SEQ_ITEM_IMAGE INCREMENT 		BY 1 START WITH 0 MINVALUE 1;
