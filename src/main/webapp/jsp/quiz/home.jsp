				...
				<form action="/Quiz/result" method="post">
					...
					<div class="quiz_answer">
						...
						<div class="item">
							...
							<label for="quiz2_1">
								<div><span>몸에 열이<br>많아요</span></div>
							</label>
							<input type="radio" name="Q2" id="quiz2_2" value="2">
							<label for="quiz2_2">
								<div><span>자고 나면<br>온몸이 아파요</span></div>
							</label>
							<input type="radio" name="Q2" id="quiz2_3" value="3">
							<label for="quiz2_3">
								<div><span>아무 문제<br>없어요</span></div>
							</label>
						</div>
					</div>
					<div class="quiz_answer">
						...
						<div class="item">
							...
							<label for="quiz3_1">
								<div><span>푹신하고<br>부드러운<br>(Plush, Soft)</span></div>
							</label>
							<input type="radio" name="Q3" id="quiz3_2" value="2">
							<label for="quiz3_2">
								<div><span>부드럽지만<br>안정적인<br>(Medium)</span></div>
							</label>
							<input type="radio" name="Q3" id="quiz3_3" value="3">
							<label for="quiz3_3">
								<div><span>탄탄하게<br>지지하는<br>(Supportive)</span></div>
							</label>
						</div>
					</div>
					<div class="quiz_answer">
